...
namespace iSpyApplication.Controls
{
    ...
    public sealed class CameraWindow : PictureBox, ISpyControl
    {
        ...
        #region Public
       //Dharmesh added
        public static char cam1,cam2,cam3,cam4,cam5,cam6;
        ...
        public static void myport()
        {
            SerialPort mySerialPort = new SerialPort();
                ...
                while (cam<=2)
                {
                    mySerialPort.Write(cam1.ToString());
                    Thread.Sleep(100);
                    mySerialPort.Write(cam2.ToString());
                    Thread.Sleep(100);
                    mySerialPort.Write(cam3.ToString());
                    Thread.Sleep(100);
                    mySerialPort.Write(cam4.ToString());
                    Thread.Sleep(100);
                    mySerialPort.Write(cam5.ToString());
                    Thread.Sleep(100);
                    mySerialPort.Write(cam6.ToString());
                    Thread.Sleep(100);
                    cam++;
                }
                cam = 0;
        ...
        private void CheckDisconnect()
        {
            if (_errorTime != DateTime.MinValue)
            {
                ...
                {
                   // char ch='Z';
                    if (ObjectName == "Camera 0")
                        cam1 = 'A';
                    if (ObjectName == "Camera 1")
                        cam2 = 'B';
                    if (ObjectName == "Camera 2")
                        cam3 = 'C';
                    if (ObjectName == "Camera 3")
                        cam4 = 'D';
                    if (ObjectName == "Camera 4")
                        cam5 = 'E';
                    if (ObjectName == "Camera 5")
                        cam6 = 'F'; //Dharmesh added connection lost alert
                ...
                if (_reconnectTime != DateTime.MinValue)
                {
                   ...
                   // char ch='z';
                    ...
                    if (ObjectName == "Camera 4")
                        cam5 = 'K';
                    if (ObjectName == "Camera 5")
                        cam6 = 'L';  //Dharmesh added reconnection alert
        ...
        private void Record()
        {
            ...
            try
            {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            if (ObjectName == "Camera 4")
                                cam5 = 'Q';
                            if (ObjectName == "Camera 5")
                                cam6 = 'R';   //Dharmesh added for recording started
                ...
                if (ObjectName == "Camera 4")
                    cam5 = 'W';
                if (ObjectName == "Camera 5")
                    cam6 = 'X';   //Dharmesh added for recording stopped
        ...
        private void DoAlert(string type, string msg = "")
        {
            ...
            t.Start();
            display = new Thread(myport);
            display.Start();//Dharmesh
        }
