    ...
    public partial class LocalServer: IDisposable
    {
        ...
        public string StartServer()
        {
            ...
            catch (Exception e)
            {
                ...
                StopServer();
                message = "Could not start local Kayson server - please select a different LAN port in settings. The port specified is in use. See the log file for more information.";
        ...
        private void ProcessRequest(string sBuffer, HttpRequest req)
        {
            ...
            try
            {
                ...
                {
                    resp = "Kayson is running. Access this server via the website";
                    if (errMessage != "")
                        resp += " (" + errMessage + ")";
                ...
                if (!bServe)
                {
                    ...
                    resp = "{\"server\":\"Kayson\",\"error\":\"Authentication failed" + errMessage +
        ...
        {
            const string resp = "Kayson server is running";
        ...
        public static List<String> AllowedReferrers
        {
            get
            {
                ...
                lock (StaticThreadLock)
                {
                    ...
                    refs.Add("http://www.Kaysonconnect.com/*");
                    refs.Add("https://www.Kaysonconnect.com/*");
                    refs.RemoveAll(p => p == "");
                    Thread.MemoryBarrier();
