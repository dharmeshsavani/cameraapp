        ...
        public static void WriteLogs()
        {
            ...
            if (_logging)
            {
                try
                {
                    ...
                    {
                        string logTemplate = "<html><head><title>Kayson v" + Application.ProductVersion + " Log File</title><style type=\"text/css\">body,td,th,div {font-family:Verdana;font-size:10px}</style></head><body><h1>" + MainForm.Conf.ServerName + ": Log Start (v" + Application.
