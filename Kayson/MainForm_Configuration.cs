...
namespace iSpyApplication
{
    public partial class MainForm
    {
        ...
        public static configuration Conf
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(_conf.AppendLinkText))
                    _conf.AppendLinkText = "<br/>Kaysonconnect.com";
                    ...
                    cam.settings.youtube = new objectsCameraSettingsYoutube
                            {
                                ...
                                tags = "Kayson, Motion Detection, Surveillance",
                                @public = true
                            };
                }
        ...
        private CameraWindow NewCameraWindow(int videoSourceIndex)
        {
            ...
            oc.ftp.ready = true;
            oc.ftp.text = "www.Kaysonconnect.com";
            oc.ftp.quality = 75;
            oc.ftp.counter = 0;
            ...
            oc.savelocal.text = "www.Kaysonconnect.com";
