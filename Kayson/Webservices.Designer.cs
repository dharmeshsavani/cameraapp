namespace iSpyApplication
{
    ...
    " the built in web server. \r\n";
            ...
            this.toolTip1.SetToolTip(this.chkReroute, "Kayson can monitor your connection and re-configure your router if your LAN IP addr" +
        "ess changes");
    ...
    "ile devices and to use Kayson alerting services  you will need an Kayson Connect acc" +
    "ount.";
            ...
            this.label7.Text = "Using IPv6 Kayson *might* be able to configure your NAT automatically";
            // 
            // txtPort
            // 
            ...
            this.label5.Text = "If you are connecting multiple instances of Kayson, you must select a different por" +
